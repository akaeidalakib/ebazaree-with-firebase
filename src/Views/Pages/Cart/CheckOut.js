...
const CheckOut = () => {
    const cartData = useSelector((state) => state.checkout.checkout)
                    ...
                    <form className="mt-5 grid gap-6">
                        <div className="relative">
                            ...
                            <label className="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" htmlFor="radio_1">
                                ...
                                <div className="ml-5">
                                    <span className="mt-2 font-semibold">Pay Now</span>
                        ...
                        <div className="relative">
                            ...
                            />
                            <span className="peer-checked:border-gray-700 absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-gray-300 bg-white"></span>
                            <label className="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" htmlhtmlFor="radio_2">
